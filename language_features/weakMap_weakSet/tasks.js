...
console.log(readStatus.has(messages[0])) // прочитано - true
console.log(readStatus.has(messages[1])) // не прочитано - false

// Когда объект удаляется из messages, он также удаляется из readStatus
